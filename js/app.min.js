...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (cFilterTriggerBtn) {
    cFilterTriggerBtn.addEventListener('click', function (event) {
      event.preventDefault();
      var parent = cFilterTriggerBtn.closest('.c-filter-trigger');
      if (!parent.classList.contains('is--active')) {
        parent.classList.add('is--active');
        cFilterTriggerBtn.querySelector('span').innerHTML = 'Скрыть';
      } else {
        parent.classList.remove('is--active');
        cFilterTriggerBtn.querySelector('span').innerHTML = 'Параметры';
      }
    });
  }
