    ...
    if (catalogFilterCheckbox) {
      catalogFilterCheckbox.forEach(function (item) {
        item.addEventListener('click', function (event) {
          ...
          // if (catalogFilterCheckbox.classList.contains('catalog-filter__checkbox--all')) {
          //     if (input.checked) {
          //         input.checked = false

          //         parent.querySelectorAll('.catalog-filter__checkbox:not(.catalog-filter__checkbox--all) input[type=checkbox]').forEach(child => child.checked = false)
          //     } else {
          //         input.checked = true

          //         parent.querySelectorAll('.catalog-filter__checkbox:not(.catalog-filter__checkbox--all) input[type=checkbox]').forEach(child => child.checked = true)
          //     }
          // } else {
          //     if (input.checked) {
          //         input.checked = false
